...
def weight_variable(shape):  # initialize weights and bias
...
if __name__=='__main__':
    ...
    h_conv1 = tf.nn.relu(conv2d(x_image, W_conv1)+b_conv1) # relu layer
    h_pool1 = max_pool_2x2(h_conv1)
    
    W_conv2 = weight_variable([5, 5, 32, 64]) # conv2 layer
    b_conv2 = bias_variable([64])
    h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2)+b_conv2) # relu layer
    h_pool2 = max_pool_2x2(h_conv2)

    W_fc1 = weight_variable([7*7*64, 1024]) # full-connection layer
